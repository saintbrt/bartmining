    ...
    <section className="sec-gap" style={{ background: dark ? 'var(--slate)' : 'var(--bg)', position: 'relative', overflow: 'hidden' }}>
      ...
      <div className="px-site">
        <Reveal className="sec-head">
          <span className="eyebrow" style={dark ? { color: 'var(--gold-2)' } : {}}>Mining Machinery &amp; Processing Plants</span>
          <h2 style={dark ? { color: '#fff' } : {}}>From exploration kit to complete gold-recovery systems.</h2>
          <p style={dark ? { color: 'rgba(255,255,255,.6)' } : {}}>
            We source, specify, supply and commission specialised mineral-processing machinery tailored to site conditions and production targets.
          </p>
        </Reveal>
