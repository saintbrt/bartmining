...
const KITS = [
  ...
  { slug: 'wet-pan-mill', sw: 'Kinu cha pani (wet pan mill)', note: 'Husaga mawe kwa rollers nzito ndani ya pani yenye maji. Ni kinu kinachotumika zaidi kwenye migodi midogo Tanzania.' },
  { slug: 'hydraulic-excavator', sw: 'Eskaveta', note: 'Inachimba na kupakia lori. Ni mashine kuu kwenye mashimo wazi na ujenzi.' },
  { slug: 'dump-truck', sw: 'Lori la kutupa mawe', note: 'Hubeba mawe na udongo kutoka shimoni hadi planti au dampo.' },
