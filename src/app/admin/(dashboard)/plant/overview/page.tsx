  ...
  return (
    <div className="content content-pad">
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 24, flexWrap: 'wrap', gap: 12 }}>
        <div>
          <h2 style={{ fontSize: 18, fontWeight: 700, marginBottom: 4 }}>Plant Overview</h2>
          <p style={{ fontSize: 12, color: 'var(--label-3)' }}>
            Tank rounds, cycle time, and pit status at a glance. Day-to-day logging happens on
            the Chemical Manager tab.
          </p>
        </div>
