...
export const EQUIPMENT: Equipment[] = [
  ...
  {
    slug: 'leaching-tank',
    name: 'Gold Leaching Tank (Agitation Tank)',
    h1: 'Gold Leaching Tank: Agitation Tank Sizes and Specifications',
    title: 'Gold Leaching Tank: Agitation Tank Specs | Tanzania',
    description:
      'Gold leaching and agitation tank specifications: tank volumes, agitator power, linings, interstage screens and sizing for small CIL and CIP plants in Tanzania.',
    summary:
      'A gold leaching tank, also called an agitation tank, is a cylindrical steel tank with a motor-driven agitator that keeps ore slurry suspended while cyanide dissolves the gold. Tanks are installed in series of five to eight to form a CIL or CIP train, each fitted with an interstage screen that holds activated carbon in place. Small Tanzanian plants typically use tanks of about 10 to 200 cubic metres each, with agitators of roughly 3 to 30 kW and air sparging to keep dissolved oxygen up.',
    category: 'processing',
    categoryLabel: CATEGORY_LABELS.processing,
    searchTerms: [
      'gold leaching tank', 'agitation tank gold', 'CIP tank Tanzania',
      'leaching tank price Tanzania', 'tanki la kuchenjua dhahabu',
    ],
    specs: [
      { label: 'Working volume per tank', value: '10–200 m³ for small plants' },
      { label: 'Tank diameter × height', value: 'About 3×3.5 m to 7×7.5 m' },
      { label: 'Tanks per train', value: '5–8 in series' },
      { label: 'Agitator power', value: '3–30 kW, per tank size and slurry density' },
      { label: 'Impeller', value: 'Hydrofoil or pitched blade, rubber lined or hardened' },
      { label: 'Slurry density', value: '40–50% solids by mass' },
      { label: 'Construction', value: 'Carbon steel, epoxy or rubber lined; bolted or welded' },
      { label: 'Interstage screen', value: 'Mechanical swept or airlift, 0.6–0.8 mm aperture' },
      { label: 'Aeration', value: 'Air or oxygen sparged, 6–10 ppm dissolved oxygen' },
      { label: 'Flow between tanks', value: 'Gravity overflow via launders, 200–400 mm step per tank' },
      { label: 'Power supply', value: '400 V 3-phase 50 Hz' },
      { label: 'Transport', value: 'Bolted panel tanks ship flat in containers' },
    ],
    applications: [
    ...
    maintenance: [
      { interval: 'Every shift', task: 'Confirm every agitator is running and slurry is fully suspended; check interstage screens are flowing and not overflowing carbon.' },
      { interval: 'Weekly', task: 'Clean or rotate interstage screens; check gearbox oil and agitator noise and vibration; inspect launders for sanding.' },
      { interval: 'Monthly', task: 'Inspect impeller wear and shaft alignment; check lining at the slurry line and tank bottom where accessible.' },
      { interval: 'Quarterly', task: 'Inspect air sparging lines and valves; survey tank walls and floor for corrosion or leaks.' },
  ...
  },
  {
    ...
    related: ['mine-management-software', 'rc-drilling-rig', 'fleet-management-system'],
    image: IMG.software,
