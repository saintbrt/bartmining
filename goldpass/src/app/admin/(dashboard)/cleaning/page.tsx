...
export default function CleaningPage() {
  ...
  return <WorkspacePage stage="cleaning" project={project} user={user!} tables={tables} onRefresh={refresh} stageDone={ss.cleaning === 'done'} onApprove={() => approveStage('cleaning')} />
}
