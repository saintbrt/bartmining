...
import { invertColMapping } from '@/lib/db/helpers'
  ...
  return (
    <div className="content content-pad">
      ...
      {!project ? (
        ...
        <div style={{ textAlign: 'center', color: 'var(--label-4)', fontSize: 13, padding: 40 }}>No collar data with coordinates available. Upload and map a collar table with easting/northing columns.</div>
      ) : (
